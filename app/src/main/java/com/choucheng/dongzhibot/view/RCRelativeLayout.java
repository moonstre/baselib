...
public class RCRelativeLayout extends RelativeLayout {
    ...
    public RCRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, com.gcssloop.rclayout.R.styleable.RCRelativeLayout);
        mRoundAsCircle = ta.getBoolean(com.gcssloop.rclayout.R.styleable.RCRelativeLayout_round_as_circle, false);
        mStrokeColor = ta.getColor(com.gcssloop.rclayout.R.styleable.RCRelativeLayout_stroke_color, Color.WHITE);
        mStrokeWidth = ta.getDimensionPixelSize(com.gcssloop.rclayout.R.styleable.RCRelativeLayout_stroke_width, 0);
        int roundCorner = ta.getDimensionPixelSize(com.gcssloop.rclayout.R.styleable.RCRelativeLayout_round_corner, 0);
        int roundCornerTopLeft = ta.getDimensionPixelSize(
                com.gcssloop.rclayout.R.styleable.RCRelativeLayout_round_corner_top_left, roundCorner);
        int roundCornerTopRight = ta.getDimensionPixelSize(
                com.gcssloop.rclayout.R.styleable.RCRelativeLayout_round_corner_top_right, roundCorner);
        int roundCornerBottomLeft = ta.getDimensionPixelSize(
                com.gcssloop.rclayout.R.styleable.RCRelativeLayout_round_corner_bottom_left, roundCorner);
        int roundCornerBottomRight = ta.getDimensionPixelSize(
                com.gcssloop.rclayout.R.styleable.RCRelativeLayout_round_corner_bottom_right, roundCorner);
